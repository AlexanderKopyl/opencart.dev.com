...
class ModelUserUserActivity extends Model
{
    ...
    public function install()
    {
        ...
        $this->model_setting_event->addEvent('user_activity', 'admin/model/setting/setting/editSetting/after', 'user/user_activity/addActivityEditSetting');

        $this->model_setting_event->addEvent('user_activity', 'admin/model/catalog/product/editProduct/after', 'user/user_activity/addActivityEditProduct');

        $this->model_setting_event->addEvent('user_activity', 'admin/model/catalog/category/editCategory/after', 'user/user_activity/addActivityEditCategory');
    ...
    public function uninstall()
    {
        ...
        $this->model_setting_event->deleteEventByCode('user_activity');
    }
}
