...
class ControllerExtensionPaymentLiqPay extends Controller
{
 	...
 	public function index()
	{
		...
		if (isset($this->error['public_sub_key'])) {
			$data['error_sub_public_key'] = $this->error['public_sub_key'];
		} else {
			$data['error_sub_public_key'] = '';
		}

		if (isset($this->error['private_sub_key'])) {
			$data['error_sub_private_key'] = $this->error['private_sub_key'];
		} else {
			$data['error_sub_private_key'] = '';
		}
		...
		if (isset($this->request->post['payment_liqpay_sub_public_key'])) {
			$data['payment_liqpay_sub_public_key'] = $this->request->post['payment_liqpay_sub_public_key'];
		} else {
			$data['payment_liqpay_sub_public_key'] = $this->config->get('payment_liqpay_sub_public_key');
		}

		if (isset($this->request->post['payment_liqpay_sub_private_key'])) {
			$data['payment_liqpay_sub_private_key'] = $this->request->post['payment_liqpay_sub_private_key'];
		} else {
			$data['payment_liqpay_sub_private_key'] = $this->config->get('payment_liqpay_sub_private_key');
		}
	...
	protected function validate()
	{
		...
		if (!$this->request->post['payment_liqpay_sub_public_key']) {
			$this->error['public_sub_key'] = $this->language->get('error_sub_public_key');
		}

		if (!$this->request->post['payment_liqpay_sub_private_key']) {
			$this->error['private_sub_key'] = $this->language->get('error_sub_private_key');
		}
