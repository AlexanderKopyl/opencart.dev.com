...
class ControllerExtensionModuleUserActivity extends Controller {
    ...
    public function index() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            $this->model_setting_setting->editSetting('module_user_activity', $this->request->post);
        ...
        $data['action'] = $this->url->link('extension/module/user_activity', 'user_token=' . $this->session->data['user_token'], true);

        $data['cancel'] = $this->url->link('marketplace/extension', 'user_token=' . $this->session->data['user_token'] . '&type=module', true);


        if (isset($this->request->post['module_user_activity_status'])) {
            $data['module_user_activity_status'] = $this->request->post['module_user_activity_status'];
        } else {
            $data['module_user_activity_status'] = $this->config->get('module_user_activity_status');
        }
