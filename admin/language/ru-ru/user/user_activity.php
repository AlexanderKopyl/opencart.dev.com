...
$_['text_update_category']    = '%s обновил категорию Действие %s в Категории c id %s.';
...
$_['text_update_product']    = '%s обновил новый товар Действие: %s  в Товаре с id %s.';
$_['text_delete_product']    = '%s удалил <a href="categoty_id=%d">новую категорию</a>.';

$_['text_edit_setting']     = '%s обновил настройки магазина Действие: %s  в настройках %s.';
